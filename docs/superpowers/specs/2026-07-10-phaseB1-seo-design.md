...
|---|---|---|
| `kpis.low_ctr` | `attention["low_ctr_count"]` | rename key |
| `kpis.anomalies` | `attention["anomaly_count"]` | rename key |
| `kpis.critical` | `attention["high_sev_issues"]` | rename key |
| `kpis.total_issues` | `attention["issue_count"]` | rename key |
